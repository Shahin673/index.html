...
<head>
    ...
    <style>
        ...
        /* Image Slider */
        .slider-container { width: 100%; overflow: hidden; margin: 20px 0; position: relative; height: 400px; background: #e0e0e0; cursor: pointer; }
        .slider-track { display: flex; transition: transform 0.5s ease-in-out; height: 100%; }
        .slider-track img { min-width: 100%; height: 100%; object-fit: contain; transition: transform 0.3s ease; }
        ...
        .bg-1 { background-color: #2980b9; }
        .bg-2 { background-color: #27ae60; }
        .bg-3 { background-color: #8e44ad; }
        .bg-4 { background-color: #d35400; }
        .bg-5 { background-color: #16a085; }
        .bg-6 { background-color: #c0392b; }
        .bg-7 { background-color: #34495e; }
        ...
        /* Family Tree Chart */
        .family-chart { display: flex; flex-direction: column; gap: 20px; background: #f9f9f9; padding: 15px; border-radius: 8px; border: 1px solid #ddd; margin-bottom: 20px; }
        ...
        /* NID & Skills Box */
        .nid-container { display: flex; gap: 20px; margin-top: 15px; justify-content: center; }
        ...
        /* Complaint Box Widget */
        #complaint-box-widget { position: fixed; bottom: 20px; right: 20px; z-index: 9999; }
        .complaint-title-btn { background: #c0392b; color: white; padding: 10px 15px; border-radius: 25px; cursor: pointer; font-weight: bold; box-shadow: 0 4px 8px rgba(0,0,0,0.3); white-space: nowrap; user-select: none; }
        #complaint-form { display: none; position: absolute; bottom: 50px; right: 0; width: 300px; background: white; border: 2px solid #c0392b; border-radius: 8px; padding: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); cursor: default; }
        #complaint-form textarea { width: 100%; height: 100px; margin-bottom: 10px; padding: 5px; box-sizing: border-box; }
        #complaint-form button { background: #c0392b; color: white; border: none; padding: 8px 15px; cursor: pointer; width: 100%; margin-bottom: 10px; border-radius: 4px; }
        ...
        .contact-links a { display: block; margin: 10px 0; color: #2980b9; text-decoration: none; font-weight: bold; background: #ecf0f1; padding: 10px; border-radius: 5px; text-align: center; }
...
<body>
    ...
    <div class="slider-container" id="slider-container">
        <div class="slider-track" id="slider">
            <img src="https://via.placeholder.com/800x400/3498db/ffffff?text=ছবি+১" alt="Slider Image 1">
            <img src="https://via.placeholder.com/800x400/e74c3c/ffffff?text=ছবি+২" alt="Slider Image 2">
            <img src="https://via.placeholder.com/800x400/2ecc71/ffffff?text=ছবি+৩" alt="Slider Image 3">
            <img src="https://via.placeholder.com/800x400/f1c40f/ffffff?text=ছবি+৪" alt="Slider Image 4">
            <img src="https://via.placeholder.com/800x400/9b59b6/ffffff?text=ছবি+৫" alt="Slider Image 5">
            <img src="https://via.placeholder.com/800x400/34495e/ffffff?text=ছবি+৬" alt="Slider Image 6">
            <img src="https://via.placeholder.com/800x400/16a085/ffffff?text=ছবি+৭" alt="Slider Image 7">
            <img src="https://via.placeholder.com/800x400/e67e22/ffffff?text=ছবি+৮" alt="Slider Image 8">
            <img src="https://via.placeholder.com/800x400/95a5a6/ffffff?text=ছবি+৯" alt="Slider Image 9">
            <img src="https://via.placeholder.com/800x400/2c3e50/ffffff?text=ছবি+১০" alt="Slider Image 10">
        </div>
    </div>
    ...
    <div class="page-panel" id="panel-1">
        ...
        <p><strong>জাতীয়তা:</strong> বাংলাদেশী</p>
        ...
        <div class="nid-container">
            <div class="nid-box">NID Front (ছবি দিন)</div>
            <div class="nid-box">NID Back (ছবি দিন)</div>
        </div>
    </div>
    ...
    <div class="page-panel" id="panel-2">
        ...
        <p>এরপর ভর্তি হয় বাংলাদেশ কারিগরি শিক্ষা বোর্ড এর আওতাভুক্ত <span class="highlight">পলিটেকনিক ইনস্টিটিউট</span> এ সিভিল ইঞ্জিনিয়ারিং নিয়ে। সেখানে ভালো ফলাফল, এমনকী সর্বোচ্চ জিপিএ ৩.৭৯ আসে।</p>
        <p>প্রাইমারিতে তার পছন্দের স্যার ছিলেন ম্যাডাম চাবুক্কুর নাহার ও এস.এম সিরাজুল হক।</p>
    ...
    <div class="page-panel" id="panel-5">
        ...
        <div class="family-chart">
            ...
            <p style="text-align:center; margin-top: 0;"><strong>নানা:</strong> কোরবান আলি | <strong>নানী:</strong> রাবেয়া খাতুন</p>
        ...
        <div class="family-chart">
            ...
            <p style="text-align:center; margin-top: 0;"><strong>দাদা:</strong> আব্দু শুক্কুর | <strong>দাদী:</strong> ছারা খাতুন</p>
            <div class="family-nodes">
    ...
    <div class="page-panel" id="panel-6">
        ...
        <p style="min-height: 200px;">(আপনার মনের কথাগুলো এখানে লিখবেন। আপাতত জায়গা ফাঁকা রাখা হলো।)</p>
    </div>
    ...
    <div class="page-panel" id="panel-7">
        ...
        <div style="text-align: center; margin-top: 10px; margin-bottom: 20px;">
            <div style="width: 120px; height: 120px; border-radius: 50%; background: #ccc; margin: 0 auto; display: flex; align-items: center; justify-content: center; overflow: hidden; border: 3px solid #34495e;">
                <span style="color: #555; font-size: 0.9rem;">ডেভলপার ছবি</span>
            </div>
        </div>
        <p style="text-align: center;"><strong>নাম:</strong> শাহিন মোস্তাফা</p>
        <p style="text-align: center;"><strong>ঠিকানা:</strong> কক্সবাজার, মহেশখালী, কালারমারছড়া</p>
        <div class="contact-links">
            <a href="tel:01842330673">📞 ০১৮৪২৩৩০৬৭৩ (Call)</a>
            <a href="tel:01621741925">📞 ০১৬২১৭৪১৯২৫ (Call)</a>
            <a href="tel:09638987792">📞 ০৯৬৩৮৯৮৭৭৯২ (Call)</a>
    ...
    <div id="complaint-box-widget">
        ...
        <div id="complaint-form">
            <h4 style="margin-top:0;">শাহিন মুস্তাফাকে আপনার অভিযোগ জানান:</h4>
            <textarea placeholder="এখানে অভিযোগ লিখুন (১০০০ শব্দের মধ্যে)..."></textarea>
    ...
    <script>
        ...
        function startSlider() {
            ...
            }, 1500); // স্লাইডারের গতি সামান্য কমানো হয়েছে যেন ভালোভাবে দেখা যায়
        }
        startSlider();

        // Pause on press and zoom
        ...
        sliderContainer.addEventListener('touchstart', pauseAndZoom, {passive: true});
        sliderContainer.addEventListener('touchend', resumeSlider, {passive: true});
        ...
        complaintToggle.addEventListener('click', (e) => {
            // ড্র্যাগ করার সময় যেন ক্লিক কাজ না করে
            if (!isDraggingMode) {
        ...
        function dragStart(e) {
            if (e.target.tagName.toLowerCase() === 'textarea' || e.target.tagName.toLowerCase() === 'input' || e.target.tagName.toLowerCase() === 'button') {
                return; // ফর্মের ভেতরে ক্লিক করলে যেন ড্র্যাগ না হয়
            }
        ...
        function dragEnd(e) { 
            ...
            initialY = currentY; 
            isDragging = false; 
            setTimeout(() => { isDraggingMode = false; }, 100);
        }

        function drag(e) {
            if (isDragging) {
                e.preventDefault();
                isDraggingMode = true; // বোঝা যাবে যে ইউজার ক্লিক নয়, ড্র্যাগ করছে
                if (e.type === "touchmove") { 
